...
import io.trxplorer.protocol.model.BlockModel;
import io.trxplorer.protocol.model.TransactionModel;
		...
		try {
		   ...
		   block.setConfirmed(confirmed);
			...
			for (Transaction rawTransaction : rawBlock.getTransactionsList()) {
				...
				for (org.tron.protos.Protocol.Transaction.Contract rawContract : rawTransaction.getRawData().getContractList()) {
